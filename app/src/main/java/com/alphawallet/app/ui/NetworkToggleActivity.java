...
public class NetworkToggleActivity extends NetworkBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(NetworkToggleViewModel.class);
    ...
    private void setupFilterList() {
        ...
        NetworkItem blockXNetwork = new NetworkItem(
            ...
            19191L, 
            true, 
            R.drawable.splash // Icon for BlockX
        );
        ...
        NetworkItem metaNovaNetwork = new NetworkItem(
            ...
            10096L, 
            true, 
            R.drawable.meta_nova // Icon for MetaNova
        );

        NetworkItem bitcoinNetwork = new NetworkItem(
            "Bitcoin", 
            0L, 
            true, 
            R.drawable.bitcoin // Icon for Bitcoin
        );
        ...
        MultiSelectNetworkAdapter.Callback callback = new MultiSelectNetworkAdapter.Callback() {
            ...
            public void onCheckChanged(long chainId, int count) {
                ...
                if (chainId == 19191L || chainId == 10096L) {
...
//     // Add BlockX, MetaNova, and Bitcoin at the top of the mainNetList
//     NetworkItem blockXNetwork = new NetworkItem("BlockX MainNet", 19191L, true); // Always selected
//     NetworkItem metaNovaNetwork = new NetworkItem("MetaNova Verse", 10096L, true); // Always selected
//     NetworkItem bitcoinNetwork = new NetworkItem("Bitcoin", 0L, true); // Bitcoin without an icon
